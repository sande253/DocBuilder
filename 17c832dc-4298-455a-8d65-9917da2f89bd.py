...
class ChromosomeExplanation(manim.Scene):
    def construct(self):
        ...
        intro_text = manim.Text("Chromosomes are thread-like structures found inside the nucleus of animal and plant cells.",
                          font_size=28, line_spacing=1.2).next_to(title, manim.DOWN, buff=0.8).align_to(manim.LEFT, manim.LEFT_SIDE)
        ...
        dna_strand2.flip(axis=manim.X_AXIS) # Flip vertically across the X-axis
        ...
        # Represent histone proteins as a single circle for simplicity
        ...
        self.play(manim.Indicate(current_structure, color=manim.YELLOW))
        self.wait(1.5)
