...
class ChromosomeExplanation(manim.Scene):
    def construct(self):
        ...
        intro_text = manim.Text("Chromosomes are thread-like structures found inside the nucleus of animal and plant cells.",
                          font_size=28, line_spacing=1.2).next_to(title, manim.DOWN, buff=0.8).align_to(manim.LEFT, manim.LEFT_SIDE) # Fixed positioning to align left while respecting vertical position
        ...
        dna_strand2.flip(axis=manim.X_AXIS) # Fixed: Flip vertically across the X-axis
