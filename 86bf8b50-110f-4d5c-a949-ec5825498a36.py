...
class BubbleSortVisualization(manim.Scene):
    def construct(self):
        ...
        for i in range(n - 1):
            # Update pass label using Transform for animation
            ...
            pass_label = new_pass_label # Update reference for the next iteration
            self.wait(0.5)
            ...
            for j in range(n - 1 - i):
                ...
                if current_array_values[j] > current_array_values[j + 1]:
                    ...
                    # Note: current_array_vgs[j] now refers to the element that was originally at j+1
                    # and current_array_vgs[j+1] refers to the element that was originally at j
                    self.play(
        ...
        # This is the element at index 0 after all swaps
